...
export function Footer() {
  ...
  return (
    <footer
      className="w-full border-t border-border/30 bg-white/30 backdrop-blur-sm mt-16 sm:mt-20"
      role="contentinfo"
    >
      <div className="max-w-4xl mx-auto px-4 py-8 md:px-8 md:py-12">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-muted-foreground">
          <p>
            © {currentYear} Cuidar.mente. Feito com{" "}
            <HeartIcon
              className="w-3 h-3 inline text-rose-500"
              aria-label="amor"
            />{" "}
            para seu bem-estar.
          </p>
          ...
          <p>
            Se você está em crise, ligue para CVV:{" "}
            <span className="font-semibold text-foreground">188</span>
          </p>
        </div>
      </div>
    </footer>
